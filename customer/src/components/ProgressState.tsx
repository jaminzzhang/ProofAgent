...
export function ProgressState({ state, active = false }: { state: CustomerRunProgressState; active?: boolean }) {
  return (
    <div className="inline-flex items-center gap-2 rounded-md border border-[var(--border)] bg-[var(--surface)] px-2.5 py-1 text-xs font-medium text-[var(--text-secondary)]">
