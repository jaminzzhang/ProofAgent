export const MODEL_FIELDS = [
  { label: 'Answer Model Provider', path: ['model', 'provider'], input: 'select' as const, options: ['deterministic', 'openai_compatible', 'azure_openai', 'anthropic'], description: 'Provider for final answer generation' },
  ...
  { label: 'Planner Provider', path: ['react', 'planner', 'provider'], input: 'select' as const, options: ['deterministic', 'openai_compatible', 'azure_openai', 'anthropic'], description: 'Provider for ReAct planner' },
  ...
  { label: 'Reviewer Provider', path: ['review', 'subagent', 'provider'], input: 'select' as const, options: ['deterministic', 'openai_compatible', 'azure_openai', 'anthropic'], description: 'Provider for review subagent' },
