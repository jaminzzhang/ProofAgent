...
def test_v3_published_agent_run_uses_controlled_react_orchestrator(
    ...
    def forbidden_run_with_langgraph(agent_yaml: Path, **kwargs: Any) -> RunResult:
    ...
    execution = run_execution_service.execute_published_agent_run(
        ...
        published_agent=PublishedAgent(
            ...
            manifest_path=Path("proof_agent/evaluation/demo/fixtures/react_enterprise_qa_v3/agent.yaml"),
