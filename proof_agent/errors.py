...
class ErrorCode(str, Enum):
    ...
    PA_HYBRID_INTAKE_009 = "PA_HYBRID_INTAKE_009"
    PA_HYBRID_WORKER_001 = "PA_HYBRID_WORKER_001"
    PA_HYBRID_WORKER_TRANSIENT = "PA_HYBRID_WORKER_TRANSIENT"
    PA_HYBRID_WORKER_REVIEW_REQUIRED = "PA_HYBRID_WORKER_REVIEW_REQUIRED"
    PA_HYBRID_WORKER_RETRY_EXHAUSTED = "PA_HYBRID_WORKER_RETRY_EXHAUSTED"
    PA_HYBRID_WORKER_INTEGRITY = "PA_HYBRID_WORKER_INTEGRITY"
