    ...
    return original.model_copy(update={
        "messages": (
            ModelMessage(role=ModelRole.SYSTEM, content=(
                ...
                "The claim field may paraphrase a conclusion rather than repeat a message substring. "
                "Require each claim label to faithfully identify an actual conclusion in the answer, "
                "and require its quote to support that conclusion. Reject unrelated, invented or "
                "misleading labels even when the original quote is genuine. "
