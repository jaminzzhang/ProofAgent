...
_CONTROLLED_REACT_V3_BASE_STAGES: tuple[WorkflowStageDescriptor, ...] = (
...
def _controlled_react_v3_stages() -> tuple[WorkflowStageDescriptor, ...]:
    return (
        WorkflowStageDescriptor(
        ...
        *(
            ...
            for stage in _CONTROLLED_REACT_V3_BASE_STAGES
        ),
    )
...
_CONTROLLED_REACT_V3_TEMPLATE = WorkflowTemplate(
    ...
    stages=_controlled_react_v3_stages(),
)
