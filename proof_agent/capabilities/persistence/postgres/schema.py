...
insurance_metadata_profiles = sa.Table(
...
insurance_metadata_profile_revisions = sa.Table(
    "insurance_metadata_profile_revisions",
    metadata,
    sa.Column("profile_revision_id", sa.Text(), primary_key=True),
...
knowledge_source_metadata_bindings = sa.Table(
    ...
    sa.Column("bound_at", UTC_TIMESTAMP, nullable=False),
)

hybrid_metadata_review_sets = sa.Table(
    "hybrid_metadata_review_sets",
    metadata,
    sa.Column("source_id", sa.Text(), primary_key=True),
    sa.Column("review_set_id", sa.Text(), primary_key=True),
    sa.Column("document_id", UUID, nullable=False),
    sa.Column("revision_id", UUID, nullable=False),
    ...
    sa.Column("review_set_json", JSONB, nullable=False),
    sa.Column("created_at", UTC_TIMESTAMP, nullable=False),
    sa.Column("updated_at", UTC_TIMESTAMP, nullable=False),
)
...
hybrid_metadata_review_decisions = sa.Table(
    ...
    sa.Column("changed_fields_json", JSONB, nullable=False),
    sa.Column("decision_json", JSONB, nullable=False),
    sa.Column("created_at", UTC_TIMESTAMP, nullable=False),
)

hybrid_metadata_workbook_exports = sa.Table(
    ...
    sa.Column("state", sa.Text(), nullable=False),
    sa.Column("manifest_json", JSONB, nullable=False),
    sa.Column("artifact_ref_json", JSONB, nullable=False),
    sa.Column("authority_json", JSONB, nullable=False),
    sa.Column("created_by", sa.Text(), nullable=False),
    sa.Column("created_at", UTC_TIMESTAMP, nullable=False),
    sa.Column("expires_at", UTC_TIMESTAMP, nullable=False),
    sa.Column("downloaded_at", UTC_TIMESTAMP),
    sa.Column("consumed_at", UTC_TIMESTAMP),
)

hybrid_metadata_workbook_previews = sa.Table(
    ...
    sa.Column("state", sa.Text(), nullable=False),
    sa.Column("preview_json", JSONB),
    sa.Column("validation_report_json", JSONB),
    sa.Column("original_ref_json", JSONB, nullable=False),
    sa.Column("authority_json", JSONB, nullable=False),
    sa.Column("created_by", sa.Text(), nullable=False),
    sa.Column("created_at", UTC_TIMESTAMP, nullable=False),
    sa.Column("expires_at", UTC_TIMESTAMP, nullable=False),
    sa.Column("applied_at", UTC_TIMESTAMP),
)

hybrid_metadata_workbook_jobs = sa.Table(
