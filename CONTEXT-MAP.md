...
- Workflow Control consumes Knowledge And Evidence, Tools Models And Memory, and Business Flow Skills through governed Control Envelope boundaries.
- Observability records projections of Workflow Control facts, but it does not own execution decisions.
- Evaluation exercises Published Agent Versions and Workflow Control behavior without becoming a runtime authority.
